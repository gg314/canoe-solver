...
class GameState():
  ...
  def is_in_canoe(self, pt, player):
    if player == Player.red:
      moves = self.board.reds
    else:
      moves = self.board.yellows
